...
import { create } from "../../../utils/api/tour";

export const tourType = [
  { value: 1, label: "Tour tham quan" },
  { value: 2, label: "Tour núi" },
  { value: 3, label: "Tour biển" },
];

function ModalAddTour({ open, handleClose, reloadData }) {
  ...
  const handleAddTour = async () => {
    try {
      ...
      notify("success", "Thêm tour du lịch thành công");
      reloadData();
    } catch (error) {}
    handleReset();
  };
